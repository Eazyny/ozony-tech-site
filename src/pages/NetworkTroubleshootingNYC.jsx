...
const NetworkTroubleshootingNYC = () => {
  ...
  const base = 'networkTroubleshootingNYC';

  const outcomes = [
    { icon: WifiOff, title: t(`${base}.outcomes.0.title`), text: t(`${base}.outcomes.0.text`) },
    { icon: Activity, title: t(`${base}.outcomes.1.title`), text: t(`${base}.outcomes.1.text`) },
    { icon: Wrench, title: t(`${base}.outcomes.2.title`), text: t(`${base}.outcomes.2.text`) }
  ];
  ...
  return (
    <ServiceLandingTemplate
      ...
      canonicalPath="/network-troubleshooting-nyc"
