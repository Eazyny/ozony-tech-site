...
const FirewallSetupConnecticut = () => {
  ...
  const base = 'firewallSetupConnecticut';
  ...
  const relatedServices = [
    ...
    { label: t(`relatedLabels.businessWifiConnecticut`), to: localized('/business-wifi-connecticut') },
  ...
  return (
    <ServiceLandingTemplate
      ...
      canonicalPath="/firewall-setup-connecticut"
