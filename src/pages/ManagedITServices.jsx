...
const ManagedITServices = () => {
  ...
  const base = 'managedITServices';

  const outcomes = [
    { icon: ShieldCheck, title: t(`${base}.outcomes.0.title`), text: t(`${base}.outcomes.0.text`) },
  ...
  const relatedServices = [
    ...
    { label: t(`relatedLabels.itSupport`), to: localized('/it-support') },
